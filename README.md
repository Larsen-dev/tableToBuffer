# tableToBuffer
Simple utility to convert mixed lua/luau tables to buffers. Can store: numbers, strings, Vector3s, CFrames and nested tables.
...
`scopesSize (16 bits) -> scopes (19 for every) -> key -> value`
